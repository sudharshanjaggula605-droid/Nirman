  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      <div className="border-b pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-foreground tracking-tight">Client Ratings & Reviews</h1>
          <p className="text-xs text-muted-foreground">Feedback and star ratings received from verified Property Owners on NIRMAN.</p>
        </div>
        ...
        <div className="flex items-center gap-3 rounded-2xl border bg-card px-4 py-2.5 shadow-sm">
          <div className="flex items-center gap-1 text-sm font-extrabold text-amber-500">
            <Star className="h-4 w-4 fill-amber-500" /> {avgRating > 0 ? avgRating.toFixed(1) : "N/A"} / 5.0
          </div>
          <span className="text-xs text-muted-foreground font-semibold">({reviews.length} Verified Reviews)</span>
        </div>
      </div>
