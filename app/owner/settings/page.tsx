...
import { Key, Globe, Check, Save } from "lucide-react";
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="border-b pb-4">
        <h1 className="text-2xl font-bold text-foreground">{t("settings.title", "Account & Interface Settings")}</h1>
        <p className="text-xs text-muted-foreground">{t("settings.subtitle", "Manage language preference, password, and notification settings")}</p>
      </div>
      ...
      <div className="rounded-2xl border bg-card p-6 space-y-8 shadow-sm text-xs">
        ...
        <div className="space-y-4 pt-2 border-t">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label htmlFor="owner-new-pass" className="font-semibold text-foreground block mb-1">
            ...
            <div>
              <label htmlFor="owner-confirm-pass" className="font-semibold text-foreground block mb-1">
                {t("settings.confirm_password", "Confirm New Password")}
              </label>
              <input
                id="owner-confirm-pass"
                type="password"
                placeholder={t("settings.confirm_placeholder", "Re-type password")}
        ...
        <div className="pt-4 border-t flex justify-end">
          ...
          >
            ...
            <span>{t("settings.save_btn", "Save Settings")}</span>
          </button>
        </div>
      </div>
    </div>
